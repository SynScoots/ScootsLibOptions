    ...
    ['createOptionsInterface'] = function(frames, fieldKeys, parentAddon, optionPageDefinitions, postBuildCallback)
        ...
        return ScootsLibOptions.core.insertOptionsPanel({
            ...
            ['callback'] = function(parent, prior)
                ...
                contentArtwork.versionString = contentArtwork:CreateFontString(nil, 'OVERLAY', 'GameFontHighlightSmall')
                contentArtwork.versionString:SetPoint('TOPRIGHT', contentArtwork, 'BOTTOMRIGHT', -10, 4)
                contentArtwork.versionString:SetText(string.format('%s |cff99fa99%s|r', ScootsLibOptions.title, ScootsLibOptions.version))
                
                local font, _, flags = contentArtwork.versionString:GetFont()
                contentArtwork.versionString:SetFont(font, 8, flags)
